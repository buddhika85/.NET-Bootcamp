...
const EditGame: React.FC = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (id) {
                    ...
                    if (gameData.imageUri) {
                        setImagePreview(gameData.imageUri);
                    }
                } else {
                    setGame({
                        id: '',
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        let result;
        if (!id) {
            result = await gamesClient.addGameAsync(game, imageFile ?? undefined);
        } else {
            game.id = id;
            result = await gamesClient.updateGameAsync(game, imageFile ?? undefined);
        }
